<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="resolutionEdit.aspx.cs" Inherits="ISPresentationLayer.resolutionEdit" %>
...
<div id="header">
	<table>
		...
		<h1>Auflösung hinzufügen</h1><a href="resolutionManagement.aspx">zurück</a><br/><br/><br/>
   	  <p>
				Breite:<br/><br/>
            <asp:TextBox class="txt_input" ID="width_tb" runat="server"></asp:TextBox>
			</p>
        <br/><br/>
            <p>
				Höhe:<br/><br/>
               <asp:TextBox class="txt_input" ID="height_tb" runat="server"></asp:TextBox><br/><br/>
            </p><br/>
            <p>
                <asp:ImageButton ID="save_btn" runat="server" ImageUrl="~/images/buttons/Speichern.png" OnClick="save_changes" />
            </p>
            <br/><br/>
       </div>
</div></div><!-- FOOTER -->
