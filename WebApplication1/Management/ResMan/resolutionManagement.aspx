<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="resolutionManagement.aspx.cs" Inherits="ISPresentationLayer.resolutionManagement" %>
...
<title>Auflösungen - Verwaltung</title>
</head>
...
<div id="header">
 ...
 <div id="contentinternal">
		...
		<h1>Auflösungen - Verwaltung</h1><a href="resolutionAdd.aspx">Auflösungen hinzufügen</a><br/><br/>

        <asp:ListView ID="res_list" runat="server" GroupPlaceHolderID="GroupPlaceHolder" ItemPlaceholderID="ItemPlaceHolder">
            <LayoutTemplate>
                <table>
            ...
            <ItemTemplate>
                <td>
                    <h2><asp:Label ID="Label1" runat="server" Text='<%#Eval("ResolutionDerived")%>'></asp:Label><br /></h2>
                   

                </td>
                <td>
                    <asp:ImageButton ID="edit_btn" ResID='<%#Eval("ID")%>' runat="server" ImageUrl="~/images/buttons/Bearbeiten.png" onClick="edit_btn_Click"/>
                    <asp:ImageButton ID="delete_btn" ResID='<%#Eval("ID")%>' runat="server" ImageUrl="~/images/buttons/Löschen.png" onClick="delete_btn_Click"/>
                </td>
            </ItemTemplate>
