<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userDetails.aspx.cs" Inherits="ISPresentationLayer.userDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head><script src="/littlescript.js"></script><script src="/littlescript.js"></script>
...
<div id="header">
 ...
 <div id="contentinternal">
        ...
        <asp:Button ID="back_btn" runat="server" Text="zurück" onClick="back_btn_Click"/>
   <br/><br/>
        	     <p>
               Benutzername:<br/>
				<asp:TextBox runat="server" ID="Username" type="text" placeholder="Pflichtfeld" /><br/><br/>
			</p>
        	<p>
                Vorname:<br/>
				<asp:TextBox runat="server" ID="Firstname" type="text" placeholder="Pflichtfeld" /><br/><br/>
			</p>
        	<p>
                Nachname:<br/>
				<asp:TextBox runat="server" ID="Lastname" type="text" placeholder="Pflichtfeld" /><br/><br/>
			</p>
        	<p>
                E-Mail Adresse:<br/>
				<asp:TextBox runat="server" ID="EMail" type="text" placeholder="Pflichtfeld" /><br/><br/>
			</p>
   	<p>
                Kennwort:<br/>
				<asp:TextBox runat="server" ID="Password" type="password" placeholder="Pflichtfeld" /><br/><br/>
		  </p>
      	<p>
                Straße:<br/>
				<asp:TextBox runat="server" ID="Address1" type="text" placeholder="Pflichtfeld" /><br/><br/>
		  </p>
      <p>
                Ort:<br/>
				<asp:TextBox runat="server" ID="Address2" type="text" placeholder="Pflichtfeld" /><br/><br/>
		  </p>
       <p>
                PLZ:<br/>
				<asp:TextBox runat="server" ID="Address3" type="text" placeholder="Pflichtfeld" /><br/><br/>
		  </p>
        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/buttons/Speichern.png" OnClick="save" />
</div>
