    ...
    public partial class categoryEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    Name.Text = newMA.getProductTypeByID((String)Session["TypeID"]).Name;
                    Price.Text = newMA.getProductTypeByID((String)Session["TypeID"]).Price.ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        protected void save_changes(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                PriceFloat = Convert.ToSingle(newPrice);
            }
            catch (Exception ex)
            {
                error_div.Visible = true;
            ...
            try
            {
                ISProductType changeProduct=newMA.getProductTypeByID((String)Session["TypeID"]);
                changeProduct.Price = PriceFloat;
                changeProduct.Name = newName;
        ...
        {
            Response.Redirect("/" + BaseFunctions.basePath + "categoryManagement.aspx");
        }
    }
}