<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="categoryEdit.aspx.cs" Inherits="ISPresentationLayer.categoryEdit" %>
...
<div id="header">
 ...
 <div id="contentinternal">
		...
		<h1>Kategorien bearbeiten</h1><asp:Button ID="back_btn" runat="server" Text="zurück" onClick="back_btn_Click"/><br/><br/><br/>
   	  <p>
				Name der Kategorie:<br/><br/>
                <asp:TextBox class="txt_input" ID="Name" runat="server"></asp:TextBox>

			</p><br/><br/>
            <p>
				Preis des Produkts (in 0,00 €):<br/><br/>
               <asp:TextBox class="txt_input" ID="Price" runat="server"></asp:TextBox>
            </p><br/>
            <p>
       	    <asp:ImageButton runat="server" ID="save" src="/images/buttons/Speichern.png" width="216" height="41" alt="speichern" OnClick="save_changes" /> 
            </p>
            <br/><br/>
      </div>
